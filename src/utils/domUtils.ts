...
/**
 * Get当前元素的left、top偏移
 *   left：元素最左侧距离Document左侧的距离
 *   top:元素最顶端距离Document顶端的距离
 *   right:元素最右侧距离Document右侧的距离
 *   bottom：元素最底端距离Document底端的距离
 *   rightIncludeBody：元素最左侧距离Document右侧的距离
 *   bottomIncludeBody：元素最底端距离Document最footer的距离
 *
 * @description:
 */
